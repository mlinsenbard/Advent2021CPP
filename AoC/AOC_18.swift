...
//            if let leftPairNum = Int(String(mutableLine[i+1])),
//               let rightPairNum = Int(String(mutableLine[i+3])) {
...
//         let left: Int = Int(floor(Double(splitNum/2)))
//         let right: Int = Int(ceil(Double(splitNum/2)))
...
//}
//
//let inputLines:[String] = sampleInput.split(separator: "\n").map({String($0)})
//
